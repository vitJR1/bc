class AccessListEntry {
  ...
  // Array of storage keys (32 byte hex values)
  // Must match pattern ^0x[0-9a-f]{64}$
  storageKeys: string[];
}

export class Signed2930Transaction {
  // Type of the transaction (should be '0x1' for EIP-2930 transactions)
  // Must match pattern ^0x1$
  type: string;
